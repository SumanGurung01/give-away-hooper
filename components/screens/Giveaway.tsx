  ...
  return (
    <div className="relative z-[5] mx-auto w-full max-w-[500px] rounded-xl bg-green-500 text-sm">
      ...
      <div
        id="floating-tag-1"
        // data-aos="fade-up"
        className="absolute left-[-300px] top-[200px] hidden w-72 rounded-md bg-zinc-100 p-4 lg:block"
      >
      ...
      <div
        id="floating-tag-2"
        className="absolute left-[-300px] top-[700px] hidden w-72 rounded-md bg-zinc-100 p-4 lg:block"
      >
      ...
      <div
        id="floating-tag-3"
        className="absolute right-[-300px] top-[500px] hidden w-72 rounded-md bg-zinc-100 p-4 lg:block"
      >
